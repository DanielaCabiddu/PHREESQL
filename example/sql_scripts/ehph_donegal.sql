...
WHERE ( dos.PARAM LIKE '%Temperature%' AND m.SURVEY LIKE 'Donegal%') ;
...
create view eb as 
select dos.ANALYSIS_ID eb_ID, dos.VALUE ebv
from main.DESCRIPTION_OF_SOLUTION dos
WHERE (dos.PARAM LIKE '%error%' AND abs(dos.VALUE) < 10) ;
