...
${script_folder}/../../build/phreesqlexe --epsg_convert --database ${script_folder}/../DB/FULL_wateq4f.db --epsg 2157 --out_database ${script_folder}/../DB/FULL_wateq4f_2157.db --out_filename ${script_folder}/../scratch/FULL_wateq4f_2157.csv

sqlite3 ${script_folder}/../DB/FULL_wateq4f_2157.db < sql_scripts/cs2cs.sql
